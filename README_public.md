...
A global FMCG manufacturer running thousands of trade promotions annually across Market A and Market B had no reliable, data-driven method to forecast promotional sell-out volume or evaluate return on investment before committing trade spend. Planning was driven by intuition and historical precedent.
...
**Infrastructure cost: £11/month at business hours for both markets combined.**  
...
- 2 live endpoints (Market A + Market B)
- Business hours: 8hrs/day × 20 working days = 160 hrs/month
- Demo/portfolio: 1 prediction run/day × ~30 min = ~15 hrs/month
- Current actual: ~60 hrs/month (based on observed live billing)
...
| One-off setup per market (CapEx) | £0.77 | — |

*Cost per prediction: £0.002. Each additional market: ~£0.77 one-off setup + £5.45/month operating cost.*

---

### Architecture

![Promotional Analytics Architecture](architecture/promotional-analytics-architecture.png)
